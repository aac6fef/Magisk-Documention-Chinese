...
> _(有些设备的 bootloader 接受 ramdisk，但检测结果却是不支持 ramdisk. 如果你的设备是这样的, 请遵循 **拥有** ramdisk 的设备的安装指南。目前没有办法检测到这种情况，所以唯一的方法就是尝试。 好在根据我们已有的信息，仅有小米的部分的部分设备有这种情况，所以大部分用户可以无视。.)_
